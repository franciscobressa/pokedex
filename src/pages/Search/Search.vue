    ...
    <div>
        <b-navbar toggleable="md" type="dark" variant="dark">
            ...
            <b-collapse id="nav-collapse" is-nav>
                <ul class="mx-auto text-center navbar-items">
                    <li class="navbar-item" href="#">
                        <router-link to="/">MINHA POKÉDEX</router-link>
                    </li>
                    <li class="navbar-item" href="#">
                        <router-link to="/capture"
                            >CAPTURAR POKÉMONS</router-link
                        >
                    </li>
                </ul>
                ...
                <b-navbar-nav class="ml-auto">
                    <b-nav-form class="d-none d-lg-block">
                        ...
                        <b-button
                            size="sm"
                            variant="danger"
                            @click="getSpecifcPokemon()"
                        >
                            <b-icon icon="search" color="#fff"> </b-icon>
                        </b-button>
                    </b-nav-form>
                </b-navbar-nav>
            </b-collapse>
        ...
        <div class="mx-auto content mb-3">
            <h2 class="text-center">Resultados para {{ NewSearchField }}</h2>
...
<script>
    ...
    export default {
        ...
        methods: {
            async getSpecifcPokemon() {
                this.NewSearchField = this.search
                this.pokemons = []
                await services.getPokemon(this.NewSearchField).then(data => {
...
<style scoped>
    ...
    .navbar {
        background-color: rgba(19, 19, 19, 0.9) rtant;
    }
    .navbar-items {
